    ...
    try {
      ...
      if (type_of_property == "Apartment") {
        ...
        let finalObj = {
          ...
          land_value: Math.round(plot_land_rate * land_area),
          type_of_property: type_of_property,
          age_of_property,
          unit_rate_considered_for_land: plot_land_rate,
          unit_rate_considered_for_ca_bua_sba: construction_rate,
          building_value: Math.round(final_valuation),
          final_valuation: Math.round(final_value),
          final_valuation_in_word: amountInWords,
          RV: Math.round(building_value * 0.9),
          DV: Math.round(building_value * 0.75),
        };
        const reportData = new ReportModel({
          ...finalObj,
          user_id,
        ...
        let finalObj = {
          ...
          land_value: Math.round(market_area),
          type_of_property: type_of_property,
          unit_rate_considered_for_land: average,
          unit_rate_considered_for_ca_bua_sba: 0,
          building_value: 0,
          final_valuation: Math.round(market_area),
          final_valuation_in_word: amountInWords,
          RV: Math.round(market_area * 0.9),
          DV: Math.round(market_area * 0.75),
        };
        const reportData = new ReportModel({
          ...finalObj,
          user_id,
